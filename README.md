...
Electronics lab experimentation
...
🛠️ What I’m Building
📌 Simulation based projects (Tinkercad Arduino experiments)
...
📁 Featured Areas
🖥️ Simulations → Virtual circuit experiments 
🍓 Pico 2W Projects → MicroPython / C embedded builds
🧪 Electronics Lab Work → School practical experiments
📊 MATLAB Work → Signal processing & system modeling (coming soon)
